# Use Case: DM_Loaitaisan_Create (Thêm mới danh mục loại tài sản)

## User Story
- Với vai trò là **Quản trị viên**, tôi muốn thêm mới danh mục loại tài sản.

## Acceptance Criteria
- Hệ thống hiển thị form thêm mới danh mục loại tài sản.
...
## Luồng chính
1. Người dùng chọn chức năng **Thêm mới danh mục loại tài sản** từ menu (**DM_Loaitaisan_Create**).
2. Hệ thống hiển thị form thêm mới danh mục (**DM_Loaitaisan_Create**).
...
## Liên kết
- Activity Diagram: [AD_DM_Loaitaisan_Create.puml]
- Form liên quan: [SCR_DM_Loaitaisan_Create.md]
